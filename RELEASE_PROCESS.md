...
Der Beta-Stand ist `1.1.9-pre.12` (Version Code 30), mit den Meilensteinen P2.13 bis P2.17 (Galileische Jupitermonde, Saturnringe & Titan, Mondterminator-Relief, SGP4-Satelliten, sphärische Winkelmessung, äquatoriale/horizontale Gitter & Referenzlinien, interaktives Star-Hopping, Beobachtungs-Challenges, Taupunktmonitor, AR-Nachtbelichtung, Handschuhmodus-Zoom und Homescreen-Widget) sowie der Behebung der Horizont-Invertierung im manuellen Stereografiemodus. Dieser Pre-Release wird von `beta` erstellt; `main` bleibt unverändert bei `1.1.8-pre.1` (Version Code 18). Ein Pre-Release ist kein Play-Store-Produktivstand; Datenschutz-, Signatur- und Store-Prüfungen bleiben vor der stabilen Veröffentlichung erforderlich.
